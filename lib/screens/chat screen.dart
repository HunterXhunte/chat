                  ...
                  child: BlocConsumer<ChatCubit,ChatStates>(
                    ...
                    builder:(c,s)=> ListView.builder(
                      ...
                      itemBuilder: (context, index) => Padding(
                        ...
                        child: Row(
                          textDirection: (cubit.registeredUser.id == cubit.allMessages[index].recieverId)
                              ? TextDirection.ltr
                              : TextDirection.rtl,
                          children: [
                            ClipRRect(
                            ...
                            Chip(label: Column(
                              ...
                              children: [
                                ...
                                Text("${cubit.allMessages[index].time}",style: TextStyle(fontSize: 12),)
                              ],
                            )),
                          ],
                        ),
                      ...
                      FloatingActionButton(
                        onPressed: ()async {
                          if(msgController.text.trim().length>0){
                            await cubit.sendMessage(msgController.text, widget.index);
                            msgController.clear();
                          }
